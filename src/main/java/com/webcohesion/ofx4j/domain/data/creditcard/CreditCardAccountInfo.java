...
public class CreditCardAccountInfo implements AccountInfo {
    ...
    public String toString() {
        return "CreditCardAccountInfo{" +
                ...
                ", supportsTransactionDetailOperations=" + supportsTransactionDetailOperations +
                ", supportsTransferToOtherAccountOperations=" + supportsTransferToOtherAccountOperations +
                ", supportsTransferFromOtherAccountOperations=" + supportsTransferFromOtherAccountOperations +
                ", status=" + status +
                '}';
    }
}