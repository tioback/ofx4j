...
public class TransferProfile {
    ...
    public String toString() {
        return "TransferProfile{" +
                ...
                ", supportsRecurringTransfers=" + supportsRecurringTransfers +
                ", supportsLoanTransfers=" + supportsLoanTransfers +
                ", supportsScheduledLoanTransfers=" + supportsScheduledLoanTransfers +
                ", supportsRecurringLoanTransfers=" + supportsRecurringLoanTransfers +
                ", supportsTransferModification=" + supportsTransferModification +
                ", supportsModelModification=" + supportsModelModification +
