...
public class SignonInfo implements SignonProfile {
    ...
    public String toString() {
        return "SignonInfo{" +
                ...
                ", maxPasswordCharacters=" + maxPasswordCharacters +
                ", passwordCharacterType=" + passwordCharacterType +
                ", passwordCaseSensitive=" + passwordCaseSensitive +
                ", passwordSpecialCharsAllowed=" + passwordSpecialCharsAllowed +
                ", passwordSpacesAllowed=" + passwordSpacesAllowed +
                ", changePasswordSupported=" + changePasswordSupported +
                ", changePasswordFirstRequired=" + changePasswordFirstRequired +
                ", additionalCredientialsLabel1='" + additionalCredientialsLabel1 + '\'' +
                ", additionalCredientialsLabel2='" + additionalCredientialsLabel2 + '\'' +
                ", clientUIDRequired=" + clientUIDRequired +
                ", authTokenRequiredForFirstSignon=" + authTokenRequiredForFirstSignon +
                ", authTokenLabel='" + authTokenLabel + '\'' +
                ", authTokenInfoURL='" + authTokenInfoURL + '\'' +
                ", mfaSupported=" + mfaSupported +
                ", mfaChallengeRequiredForFirstSignon=" + mfaChallengeRequiredForFirstSignon +
                "}";
    }
}
