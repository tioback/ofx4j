...
public class BillpayV1MessageSetInfo extends VersionSpecificMessageSetInfo {
    ...
    public String toString() {
        ...
        return "BillpayV1MessageSetInfo{" +
                ...
                "daysWith=" + daysWith +
                ", defaultDaysToPay=" + defaultDaysToPay +
                ", transferDaysWith=" + transferDaysWith +
                ", transferDefaultDaysToPay=" + transferDefaultDaysToPay +
                ", processorDaysOff=" + processorDaysOff +
                ", processorEndTime='" + processorEndTime + '\'' +
                ", modelWindow=" + modelWindow +
                ", postProcessorWindow=" + postProcessorWindow +
                ", supportsStatusUpdateViaPaymentModificationResponse=" + supportsStatusUpdateViaPaymentModificationResponse +
                ", supportsPaymentByAddress=" + supportsPaymentByAddress +
                ", supportsPaymentByTransfer=" + supportsPaymentByTransfer +
                ", supportsPaymentByPayeeId=" + supportsPaymentByPayeeId +
                ", userCanAddPayee=" + userCanAddPayee +
                ", supportsExtendedPayment=" + supportsExtendedPayment +
                ", canModifyPayments=" + canModifyPayments +
                ", canModifyModels=" + canModifyModels +
                ", supportsDifferentFirstPayment=" + supportsDifferentFirstPayment +
                ", supportsDifferentLastPayment=" + supportsDifferentLastPayment +
                ", supportsBillPresentmentContext=" + supportsBillPresentmentContext +
                "}";
    }
}